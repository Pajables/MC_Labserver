...
sql = """INSERT INTO Reaction_Status(ROBOT_ID, ROBOT_NAME, REACTION_NAME, REACTION_STATUS, JOB_COMPLETION_DATE)
   VALUES('UJFB1', 'UJ Fluidic Backbone 1', 'Aspirin Synthesis', 'In-Progress', NULL);
   INSERT INTO Reaction_Status(ROBOT_ID, ROBOT_NAME, REACTION_NAME, REACTION_STATUS, JOB_COMPLETION_DATE)
   VALUES('UJFB1', 'UJ Fluidic Backbone 1', 'Aspirin Synthesis', 'Complete', 20210709)"""
